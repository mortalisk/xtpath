...
for boost_rtopt_ in $boost_rtopt '' -d; do
  for boost_lib in \
    boost_$1$with_boost_buildid$boost_tag_$boost_mt_$boost_rtopt_$boost_ver_ \
    boost_$1$with_boost_buildid$boost_tag_$boost_rtopt_$boost_ver_ \
    boost_$1$with_boost_buildid$boost_tag_$boost_mt_$boost_ver_ \
    boost_$1$with_boost_buildid$boost_tag_$boost_ver_
  do
...
AC_DEFUN([_BOOST_BUILDID],
[AC_ARG_WITH([boost-buildid],
  AS_HELP_STRING([--with-boost-buildid=ID],
                 [Add buildid ID to the library names]),
  [with_boost_buildid="-$with_boost_buildid"],
  [with_boost_buildid=""])
])
